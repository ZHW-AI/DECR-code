...
def plot_sample_cv2(names, imgs, scores_: dict, gts, save_folder=None):
    ...
    for k, v in scores.items():
        ...
        scores[k] = (scores[k] - min_value) / max_value * 255 #Max归一化
        # scores[k] = (scores[k] - min_value) / (max_value-min_value) * 255 #Min-Max归一化
...
def plot_anomaly_score_distributions(scores: dict, ground_truths_list, save_folder, class_name):
    ...
    for k, v in scores.items():
        ...
        with plt.style.context(['seaborn', 'ggplot', 'default']):
